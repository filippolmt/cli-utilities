...
native streaming instead of polling.`,
  ...
  changedetection-pp-cli tail --interval 10s

  # Tail a specific resource
  changedetection-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  changedetection-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
