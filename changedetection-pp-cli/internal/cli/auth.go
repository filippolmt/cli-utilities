...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Changedetection Io",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  changedetection-pp-cli auth setup\n  changedetection-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "See API docs: https://github.com/dgtlmoon/changedetection.io")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Set one of:")
			fmt.Fprintln(w, "  export CHANGEDETECTION_API_KEY=\"your-token-here\"")
			fmt.Fprintln(w, "  export CHANGEDETECTION_IO_API_KEY=\"your-token-here\"")
			if !launch {
				return nil
			}
			launchURL := "https://github.com/dgtlmoon/changedetection.io"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  changedetection-pp-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  changedetection-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  changedetection-pp-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("CHANGEDETECTION_API_KEY") != "" {
				envStillSet = "CHANGEDETECTION_API_KEY"
			}
			if envStillSet == "" && os.Getenv("CHANGEDETECTION_IO_API_KEY") != "" {
				envStillSet = "CHANGEDETECTION_IO_API_KEY"
			}
