...
but do not stop the import.`,
  ...
  changedetection-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  changedetection-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | changedetection-pp-cli import <resource> --input -`,
