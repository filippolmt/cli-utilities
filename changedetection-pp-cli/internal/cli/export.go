...
large datasets as it has no memory pressure.`,
  ...
  changedetection-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  changedetection-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  changedetection-pp-cli export <resource> --format jsonl | jq '.id'`,
